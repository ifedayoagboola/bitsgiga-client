        ...
        >
            <div className="container-x mx-auto relative h-full">
                <div className="thumb absolute -left-[140px] -top-[87px] w-[520px] h-[394px]">
                    <img src="/assets/images/discount-banner-3.1.png" alt="" className="w-full h-full object-contain"/>
                </div>
                <div className="flex justify-center items-center w-full h-full relative left-[100px]">
                   <div>
