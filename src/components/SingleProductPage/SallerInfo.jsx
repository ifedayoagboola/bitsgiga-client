...
export default function SallerInfo({ products }) {
  return (
    <div className="saller-info-wrapper w-full">
      <div className="saller-info flex justify-between items-center pb-[30px] border-b border-[#E8E8E8]">
        <div className="flex space-x-5 items-center w-1/4">
        ...
        <div className="flex-1 w-full flex space-x-5 justify-between ml-[60px]">
