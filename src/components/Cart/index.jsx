  ...
  return (
    <>
      <div
        ...
        className={`cart-wrappwer w-[300px] bg-white border-t-[3px] border-qyellow ${
          className || ""
        }`}
      >
              ...
              <li className="w-full h-full flex">
                ...
                <span className="mt-[20px] mr-[15px] inline-flex cursor-pointer ">
                  <svg
                    ...
                    viewBox="0 0 8 8"
                    fill="none"
                    className="inline fill-current text-[#AAAAAA] hover:text-qred text-[#AAAAAA] hover:text-qred"
