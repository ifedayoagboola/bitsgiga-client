...
export default function Navbar({ className }) {
  ...
  return (
    <div
      className={`w-full bg-qyellow h-[60px] relative z-30  ${className || ""}`}
    >
            ...
            <div className="category w-[270px] h-[53px] bg-white px-5 rounded-t-md mt-[6px] relative">
              ...
              >
                <ul className="categories-list">
                  <li className="category-item flex justify-between items-center px-5 h-10 bg-white hover:bg-qyellow transition-all duration-300 ease-in-out cursor-pointer">
