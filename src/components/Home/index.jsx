  ...
  return (
    <>
      <Layout>
        ...
        <ProductsAds
          ads={[
            "/assets/images/ads-1-1.png",
            "/assets/images/ads-2-2.png",
          ]}
          sectionHeight="sm:h-[295px] h-full"
          className="products-ads-section mb-[60px]"
        />
        <SectionStyleOne
          categoryBackground="/assets/images/section-category-3.png"
